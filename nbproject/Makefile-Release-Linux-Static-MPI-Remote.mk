...
CND_DLIB_EXT=so
CND_CONF=Release-Linux-Static-MPI-Remote
CND_DISTDIR=dist
CND_BUILDDIR=build
...
# CC Compiler Flags
CCFLAGS=-m64 -pedantic -Wextra -fPIC
CXXFLAGS=-m64 -pedantic -Wextra -fPIC
...
${OBJECTDIR}/AString.o: AString.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AString.o AString.cpp

${OBJECTDIR}/AStringFunctions.o: AStringFunctions.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AStringFunctions.o AStringFunctions.cpp

${OBJECTDIR}/ArgParser.o: ArgParser.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArgParser.o ArgParser.cpp

${OBJECTDIR}/Boundary.o: Boundary.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Boundary.o Boundary.cpp

${OBJECTDIR}/Cluster.o: Cluster.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cluster.o Cluster.cpp

${OBJECTDIR}/DirectoryFunctions.o: DirectoryFunctions.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DirectoryFunctions.o DirectoryFunctions.cpp

${OBJECTDIR}/FileLoad.o: FileLoad.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileLoad.o FileLoad.cpp

${OBJECTDIR}/FileStrings.o: FileStrings.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileStrings.o FileStrings.cpp

${OBJECTDIR}/Gene.o: Gene.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gene.o Gene.cpp

${OBJECTDIR}/GeneBuilder.o: GeneBuilder.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneBuilder.o GeneBuilder.cpp

${OBJECTDIR}/GeneList.o: GeneList.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneList.o GeneList.cpp

${OBJECTDIR}/ImgClusters.o: ImgClusters.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImgClusters.o ImgClusters.cpp

${OBJECTDIR}/LinearModel.o: LinearModel.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearModel.o LinearModel.cpp

${OBJECTDIR}/MatTFunctions.o: MatTFunctions.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatTFunctions.o MatTFunctions.cpp

${OBJECTDIR}/NDArray.o: NDArray.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDArray.o NDArray.cpp

${OBJECTDIR}/NDPoint.o: NDPoint.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDPoint.o NDPoint.cpp
...
${OBJECTDIR}/SRAL.o: SRAL.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SRAL.o SRAL.cpp

${OBJECTDIR}/StatsF.o: StatsF.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsF.o StatsF.cpp

${OBJECTDIR}/StringAddress.o: StringAddress.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringAddress.o StringAddress.cpp

${OBJECTDIR}/TopNeighbor.o: TopNeighbor.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopNeighbor.o TopNeighbor.cpp

${OBJECTDIR}/fft.o: fft.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fft.o fft.cpp
...
${OBJECTDIR}/miscfunctions.o: miscfunctions.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/miscfunctions.o miscfunctions.cpp

${OBJECTDIR}/random.o: random.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/random.o random.cpp

${OBJECTDIR}/stringconversion.o: stringconversion.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
...
${TESTDIR}/tests/validator.o: tests/validator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -std=c++11 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/validator.o tests/validator.cpp
...
${OBJECTDIR}/ArgParser_nomain.o: ${OBJECTDIR}/ArgParser.o ArgParser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArgParser_nomain.o ArgParser.cpp;\
	else  \
...
${OBJECTDIR}/Cluster_nomain.o: ${OBJECTDIR}/Cluster.o Cluster.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Cluster_nomain.o Cluster.cpp;\
	else  \
...
${OBJECTDIR}/Gene_nomain.o: ${OBJECTDIR}/Gene.o Gene.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gene_nomain.o Gene.cpp;\
	else  \
...
${OBJECTDIR}/GeneBuilder_nomain.o: ${OBJECTDIR}/GeneBuilder.o GeneBuilder.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneBuilder_nomain.o GeneBuilder.cpp;\
	else  \
...
${OBJECTDIR}/GeneList_nomain.o: ${OBJECTDIR}/GeneList.o GeneList.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneList_nomain.o GeneList.cpp;\
	else  \
...
${OBJECTDIR}/ImgClusters_nomain.o: ${OBJECTDIR}/ImgClusters.o ImgClusters.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImgClusters_nomain.o ImgClusters.cpp;\
	else  \
...
${OBJECTDIR}/MatTFunctions_nomain.o: ${OBJECTDIR}/MatTFunctions.o MatTFunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatTFunctions_nomain.o MatTFunctions.cpp;\
	else  \
...
${OBJECTDIR}/NDArray_nomain.o: ${OBJECTDIR}/NDArray.o NDArray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDArray_nomain.o NDArray.cpp;\
	else  \
...
${OBJECTDIR}/NDPoint_nomain.o: ${OBJECTDIR}/NDPoint.o NDPoint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDPoint_nomain.o NDPoint.cpp;\
	else  \
...
${OBJECTDIR}/fft_nomain.o: ${OBJECTDIR}/fft.o fft.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fft_nomain.o fft.cpp;\
	else  \
