...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libglitch

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libglitch: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libglitch ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/AString.o: AString.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AString.o AString.cpp

${OBJECTDIR}/AStringFunctions.o: AStringFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AStringFunctions.o AStringFunctions.cpp

${OBJECTDIR}/ArgParser.o: ArgParser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArgParser.o ArgParser.cpp

${OBJECTDIR}/Boundary.o: Boundary.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Boundary.o Boundary.cpp
...
${OBJECTDIR}/DirectoryFunctions.o: DirectoryFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DirectoryFunctions.o DirectoryFunctions.cpp

${OBJECTDIR}/FileLoad.o: FileLoad.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileLoad.o FileLoad.cpp

${OBJECTDIR}/FileStrings.o: FileStrings.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileStrings.o FileStrings.cpp
...
${OBJECTDIR}/GeneBuilder.o: GeneBuilder.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneBuilder.o GeneBuilder.cpp

${OBJECTDIR}/GeneList.o: GeneList.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneList.o GeneList.cpp

${OBJECTDIR}/ImgClusters.o: ImgClusters.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImgClusters.o ImgClusters.cpp

${OBJECTDIR}/LinearModel.o: LinearModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearModel.o LinearModel.cpp

${OBJECTDIR}/MatTFunctions.o: MatTFunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatTFunctions.o MatTFunctions.cpp

${OBJECTDIR}/NDArray.o: NDArray.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDArray.o NDArray.cpp

${OBJECTDIR}/NDPoint.o: NDPoint.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDPoint.o NDPoint.cpp
...
${OBJECTDIR}/SRAL.o: SRAL.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SRAL.o SRAL.cpp

${OBJECTDIR}/StatsF.o: StatsF.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsF.o StatsF.cpp

${OBJECTDIR}/StringAddress.o: StringAddress.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringAddress.o StringAddress.cpp

${OBJECTDIR}/TopNeighbor.o: TopNeighbor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopNeighbor.o TopNeighbor.cpp
...
${OBJECTDIR}/miscfunctions.o: miscfunctions.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/miscfunctions.o miscfunctions.cpp
...
${OBJECTDIR}/stringconversion.o: stringconversion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stringconversion.o stringconversion.cpp
...
${TESTDIR}/tests/validator.o: tests/validator.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/validator.o tests/validator.cpp
...
${OBJECTDIR}/AString_nomain.o: ${OBJECTDIR}/AString.o AString.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AString_nomain.o AString.cpp;\
	else  \
...
${OBJECTDIR}/AStringFunctions_nomain.o: ${OBJECTDIR}/AStringFunctions.o AStringFunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AStringFunctions_nomain.o AStringFunctions.cpp;\
	else  \
...
${OBJECTDIR}/ArgParser_nomain.o: ${OBJECTDIR}/ArgParser.o ArgParser.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArgParser_nomain.o ArgParser.cpp;\
	else  \
...
${OBJECTDIR}/Boundary_nomain.o: ${OBJECTDIR}/Boundary.o Boundary.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Boundary_nomain.o Boundary.cpp;\
	else  \
...
${OBJECTDIR}/DirectoryFunctions_nomain.o: ${OBJECTDIR}/DirectoryFunctions.o DirectoryFunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DirectoryFunctions_nomain.o DirectoryFunctions.cpp;\
	else  \
...
${OBJECTDIR}/FileLoad_nomain.o: ${OBJECTDIR}/FileLoad.o FileLoad.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileLoad_nomain.o FileLoad.cpp;\
	else  \
...
${OBJECTDIR}/FileStrings_nomain.o: ${OBJECTDIR}/FileStrings.o FileStrings.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FileStrings_nomain.o FileStrings.cpp;\
	else  \
...
${OBJECTDIR}/Gene_nomain.o: ${OBJECTDIR}/Gene.o Gene.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gene_nomain.o Gene.cpp;\
	else  \
...
${OBJECTDIR}/GeneBuilder_nomain.o: ${OBJECTDIR}/GeneBuilder.o GeneBuilder.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneBuilder_nomain.o GeneBuilder.cpp;\
	else  \
...
${OBJECTDIR}/GeneList_nomain.o: ${OBJECTDIR}/GeneList.o GeneList.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GeneList_nomain.o GeneList.cpp;\
	else  \
...
${OBJECTDIR}/ImgClusters_nomain.o: ${OBJECTDIR}/ImgClusters.o ImgClusters.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImgClusters_nomain.o ImgClusters.cpp;\
	else  \
...
${OBJECTDIR}/LinearModel_nomain.o: ${OBJECTDIR}/LinearModel.o LinearModel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinearModel_nomain.o LinearModel.cpp;\
	else  \
...
${OBJECTDIR}/MatTFunctions_nomain.o: ${OBJECTDIR}/MatTFunctions.o MatTFunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MatTFunctions_nomain.o MatTFunctions.cpp;\
	else  \
...
${OBJECTDIR}/NDArray_nomain.o: ${OBJECTDIR}/NDArray.o NDArray.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDArray_nomain.o NDArray.cpp;\
	else  \
...
${OBJECTDIR}/NDPoint_nomain.o: ${OBJECTDIR}/NDPoint.o NDPoint.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NDPoint_nomain.o NDPoint.cpp;\
	else  \
...
${OBJECTDIR}/SRAL_nomain.o: ${OBJECTDIR}/SRAL.o SRAL.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SRAL_nomain.o SRAL.cpp;\
	else  \
...
${OBJECTDIR}/StatsF_nomain.o: ${OBJECTDIR}/StatsF.o StatsF.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StatsF_nomain.o StatsF.cpp;\
	else  \
...
${OBJECTDIR}/StringAddress_nomain.o: ${OBJECTDIR}/StringAddress.o StringAddress.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringAddress_nomain.o StringAddress.cpp;\
	else  \
...
${OBJECTDIR}/TopNeighbor_nomain.o: ${OBJECTDIR}/TopNeighbor.o TopNeighbor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TopNeighbor_nomain.o TopNeighbor.cpp;\
	else  \
...
${OBJECTDIR}/fft_nomain.o: ${OBJECTDIR}/fft.o fft.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fft_nomain.o fft.cpp;\
	else  \
...
${OBJECTDIR}/miscfunctions_nomain.o: ${OBJECTDIR}/miscfunctions.o miscfunctions.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/miscfunctions_nomain.o miscfunctions.cpp;\
	else  \
...
${OBJECTDIR}/random_nomain.o: ${OBJECTDIR}/random.o random.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/random_nomain.o random.cpp;\
	else  \
...
${OBJECTDIR}/stringconversion_nomain.o: ${OBJECTDIR}/stringconversion.o stringconversion.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stringconversion_nomain.o stringconversion.cpp;\
	else  \
